        ...
        <div className="mt-12 grid gap-6 lg:grid-cols-3">
          <div className="lg:col-span-2 rounded-2xl border border-gray-200 bg-white p-8 shadow-sm">
            ...
            <div className="mt-8 flex flex-col sm:flex-row gap-3">
              <a href="#checkout" className="inline-flex items-center justify-center rounded-xl bg-gray-900 text-white px-6 py-3 font-semibold shadow-sm hover:bg-black/90">
                <Rocket className="h-5 w-5 mr-2" />
                Start Now
              </a>
              <a href="#support" className="inline-flex items-center justify-center rounded-xl bg-white text-gray-900 px-6 py-3 font-semibold shadow-sm ring-1 ring-gray-200 hover:bg-gray-50">
          ...
          <div className="rounded-2xl border border-gray-200 bg-gradient-to-br from-blue-50 to-violet-50 p-8 shadow-sm">
